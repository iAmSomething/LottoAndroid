...
- 실기기 부재 대응 운영 트랙(`BM-001`~`BM-005`) - `BM-001` 완료(2026-03-03, `69` 주간 루틴/캘린더 고정), `BM-002` 완료(2026-03-03, `70` 주간 비교 템플릿), `BM-003` 완료(2026-03-03, `71` 장기화 리스크 기준), `BM-004` 완료(2026-03-03, `72` 즉시 실행 번들 명령/완료 판정), `BM-005` 예정
